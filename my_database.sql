...
ALTER TABLE projects_id_seq OWNER TO admin;
...
--
-- Name: volunteers; Type: TABLE; Schema: public; Owner: admin
--
...
ALTER TABLE volunteers OWNER TO admin;

--
-- Name: volunteers_id_seq; Type: SEQUENCE; Schema: public; Owner: admin
--
...
ALTER TABLE volunteers_id_seq OWNER TO admin;

--
-- Name: volunteers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: admin
--
...
--
-- Name: volunteers id; Type: DEFAULT; Schema: public; Owner: admin
--
...
--
-- Data for Name: volunteers; Type: TABLE DATA; Schema: public; Owner: admin
--
...
--
-- Name: volunteers_id_seq; Type: SEQUENCE SET; Schema: public; Owner: admin
--
...
--
-- Name: volunteers volunteers_pkey; Type: CONSTRAINT; Schema: public; Owner: admin
--
